...
public class MyExpandableAdapter1 extends BaseExpandableListAdapter {
    ...
    public void setInflater(LayoutInflater inflater, FirstActivity activity) {
  ...
  final Button textView;
        ...
        textView = (Button) convertView.findViewById(R.id.textView2);
        textView.setText(child.get(childPosition));
        ///Toast.makeText(ctx,child.get(childPosition),Toast.LENGTH_SHORT).show();
//        final Button finalTextView = textView;
        textView.setOnClickListener(new OnClickListener() {

            @Override
            public void onClick(View view) {
                if (sp.getBoolean(""+textView.getText(), false)) {
                    Log.d("dataaaaaaaaaaj", "yup");
                    Intent i = new Intent(ctx, NotificationsActivity.class);
                    Log.d("positionn", "" + childPosition);
