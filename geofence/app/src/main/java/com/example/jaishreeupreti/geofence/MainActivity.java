...
public class MainActivity extends FragmentActivity implements OnCameraChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGeofenceCoordinates.add(new LatLng(22.3166528, 87.30560318));
        mGeofenceCoordinates.add(new LatLng(22.3177260, 87.3091010));
        ...
        mGeofences.add(new Geofence.Builder()
                ...
                .setTransitionTypes(
                        Geofence.GEOFENCE_TRANSITION_ENTER
                                | Geofence.GEOFENCE_TRANSITION_DWELL
                                | Geofence.GEOFENCE_TRANSITION_EXIT).build());
        Toast.makeText(getApplicationContext(),"twooo",Toast.LENGTH_LONG).show();
...
//        mMap.addCircle(new CircleOptions().center(mGeofenceCoordinates.get(1))
//                .radius(mGeofenceRadius.get(1).intValue())
